...
\def\@seccntformat#1{\@ifundefined{#1@cntformat}%
    ...
    \newcommand{\subsection@cntformat}{\textcolor{red!70}{$\heartsuit$\hspace{0.1cm}\thesubsection}\quad}
    \newcommand{\subsubsection@cntformat}{\textcolor{green!75!blue}{$\diamondsuit$\hspace{0.1cm}\thesubsubsection}\quad}
    \newcommand{\subsubsubsection@cntformat}{\textcolor{green!75!blue}{$\clubsuit$\hspace{0.1cm}\thesubsubsection}\quad}
